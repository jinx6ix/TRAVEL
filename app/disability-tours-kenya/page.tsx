...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "special needs safari in Kenya",
    "mobility impaired kenya tours",
    "adapted safari vehicles in Kenya",
    "barrier-free kenya travel",
    "inclusive safari experiences in Kenya",
    "disabled travel kenya",
    "Wheelchair safaris in kenya",
    "Wheelchair accessible safaris in kenya",
    "Accessible safari landcruisers in kenya",
    "Accessible safaris on kenya",
    "Accessible tours in kenya",
    "wheelchair accessible safaris in Kenya",
    "wheelchair accessible safaris landcruiser in Kenya",
