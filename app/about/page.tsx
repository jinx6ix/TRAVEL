...
const teamMembers = [
  ...
  },
  {
    ...
    experience: "12 years",
    description:
      "An expert in wildlife behavior and conservation, Mary leads our guests on unforgettable safari adventures.",
  },
  {
    name: "David Mwangi",
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-lg text-gray-600 mb-6">
                Founded in 2009, Safari Adventures began as a small family business with a simple mission: to share the
