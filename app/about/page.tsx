...
export const metadata: Metadata = {
  ...
  description:
    "Meet the team behind JaeTravel Expeditions - trusted East African safari experts with 15+ years of experience.",
  openGraph: {
    title: "About JaeTravel Expeditions - Safari Experts",
    description:
      "15+ years creating unforgettable safari experiences across East Africa with expert guides and sustainable tourism practices.",
    images: [
      "https://images.unsplash.com/photo-1516426122078-c23e76319801?auto=format&fit=crop&w=800&q=80",
    ],
  },
  keywords:
    "safari experts, East Africa tours, wildlife guides, sustainable tourism, Kenya safari, Tanzania tours",
}
...
const values = [
  {
    icon: "Heart",
    title: "Passion",
    desc: "We love what we do and it shows in every safari.",
  },
  {
    icon: "Globe",
    title: "Sustainability",
    desc: "Responsible tourism benefiting communities and wildlife.",
  },
  {
    icon: "Star",
    title: "Excellence",
    desc: "We strive for the highest standards in service & safety.",
  },
  {
    icon: "Users",
    title: "Community",
    desc: "Supporting locals and fostering cultural exchange.",
  },
]
...
export default function AboutPage() {
  ...
  // Collect critical images (hero + team members)
  const criticalImages = [
    "https://images.unsplash.com/photo-1516426122078-c23e76319801?auto=format&fit=crop&w=800&q=80",
    ...teamMembers.filter(m => m.image).map(m => m.image),
  ]
