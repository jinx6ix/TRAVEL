...
// SEO-optimized blog content with targeted keywords
const blogPosts = [
  {
    id: 1,
    title: "Best Time to Visit Masai Mara for the Great Migration | Safari Guide",
    excerpt: "Discover the optimal timing to witness one of nature's most spectacular events in Kenya's premier wildlife destination. Our expert guide covers migration patterns, weather conditions, and wildlife viewing tips.",
  ...
  {
    id: 2,
    title: "Gorilla Trekking in Rwanda: Complete Guide & Tips 2024",
    excerpt: "Everything you need to know about planning your gorilla trekking adventure in Volcanoes National Park. Permits, preparation, and what to expect when encountering mountain gorillas.",
    ...
    slug: "rwanda-gorilla-trekking-complete-guide"
  },
  {
    id: 3,
    title: "Safari Photography Tips: Capture Stunning Wildlife Photos",
    excerpt: "Professional tips to capture stunning wildlife photos during your East African safari experience. Camera settings, lens recommendations, and composition techniques.",
    image: "https://ik.imagekit.io/jinx/travel/new%20(1).png?updatedAt=1750098099514?height=300&width=400",
    author: "David Mwangi",
    date: "2024-01-05",
    readTime: "6 min read",
    category: "Safari Photography",
    slug: "safari-photography-tips-wildlife-photos"
  },
  {
    id: 4,
    title: "Cultural Experiences: Meeting the Maasai People in Kenya",
    excerpt: "Learn about authentic cultural interactions and respectful tourism practices with local communities. Discover Maasai traditions, ceremonies, and village visits.",
    image: "https://ik.imagekit.io/jinx/travel/magestic-maasai-serengeti.jpg?updatedAt=1750013375250?height=300&width=400",
    author: "Sarah Akinyi",
    date: "2023-12-28",
    readTime: "7 min read",
    category: "Cultural Safari",
    slug: "maasai-cultural-experience-kenya-safari"
  },
  {
    id: 5,
    title: "Climbing Mount Kilimanjaro: Routes, Preparation & Tips",
    excerpt: "A comprehensive guide to Africa's highest peak, including route options, training tips, and what to expect on your Kilimanjaro climbing adventure.",
    image: "https://ik.imagekit.io/jinx/travel/kilimanjaro-moutain-climbing.jpg?updatedAt=1750013910253?height=300&width=400",
    author: "John Safari",
    date: "2023-12-20",
    readTime: "10 min read",
    category: "Adventure Travel",
    slug: "climbing-mount-kilimanjaro-routes-preparation"
  },
  {
    id: 6,
    title: "Sustainable Safari Tourism in East Africa | Eco-Friendly Travel",
    excerpt: "How responsible tourism practices benefit wildlife conservation and local communities. Support ethical safari operators and minimize your environmental impact.",
    image: "https://ik.imagekit.io/jinx/4-Days-Ngorongoro-Wildlife-Tour.jpg?updatedAt=1750076232872?height=300&width=400",
    author: "Mary Kimani",
    date: "2023-12-15",
    readTime: "6 min read",
    category: "Eco Tourism",
    slug: "sustainable-safari-tourism-east-africa"
  },
  {
    id: 7,
    title: "Safari Packing List: Essentials for Your African Adventure",
    excerpt: "The ultimate packing checklist for your East African safari, from clothing to camera gear. What to bring for game drives, climate variations, and cultural respect.",
    ...
    slug: "safari-packing-list-essentials-africa"
  },
  {
    id: 8,
    title: "Bird Watching in Uganda: Diverse Species & Best Locations",
    excerpt: "Discover Uganda's incredible bird diversity across different habitats and national parks. Prime birding spots and seasonal patterns for avid birdwatchers.",
...
const categoryKeys = ["all", "wildlife safari", "adventure travel", "safari photography", "cultural experience", "eco tourism", "travel tips"];
  ...
  return (
    <div className="min-h-screen pt-16">
      ...
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify(generateBlogStructuredData()) }}
      />
      ...
      <main>
        {activeTab === 'blog' ? (
          <>
            {/* Featured Post with semantic article markup */}
            {featuredPost && (
                    ...
                    <Card className="overflow-hidden hover:shadow-2xl transition-shadow duration-300">
                      <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
                        ...
                        <div className="p-8 flex flex-col justify-center">
                          <Badge variant="outline" className="w-fit mb-4" itemProp="keywords">
                            {featuredPost.category}
                          </Badge>
                          <CardHeader className="p-0 mb-4">
                            <CardTitle className="text-2xl lg:text-3xl mb-2" itemProp="headline">
                              {featuredPost.title}
                            </CardTitle>
            ...
            {/* Categories filter */}
            <section className="py-8 bg-gray-50 border-y" aria-label="Blog categories">
              <div className="container mx-auto px-4">
                  ...
                  {regularPosts.map((post) => (
                    <motion.article key={post.id} variants={itemVariants} itemScope itemType="https://schema.org/BlogPosting">
                      <Card className="overflow-hidden hover:shadow-xl transition-shadow duration-300 h-full group">
                        ...
                        <CardHeader>
                          <CardTitle className="text-xl line-clamp-2 group-hover:text-orange-600 transition-colors" itemProp="headline">
                            {post.title}
                          </CardTitle>
                        ...
                        <CardContent className="flex-1 flex flex-col justify-between">
                          ...
                          <div className="flex items-center justify-between">
                            <time dateTime={post.date} className="text-sm text-gray-500" itemProp="datePublished">
          ...
          <>
            {/* Gallery content with improved semantics */}
            <section className="py-12" aria-label="Safari photo and video gallery">
              <div className="container mx-auto px-4">
                <motion.h2
        ...
        {/* Newsletter Signup with improved semantics */}
        <section className="py-20 bg-orange-600 text-white" aria-label="Subscribe to our newsletter">
          <div className="container mx-auto px-4 text-center">
            <motion.div
              initial={{ opacity: 0, y: 30 }}
              whileInView={{ opacity: 1, y: 0 }}
              ...
              viewport={{ once: true }}
            >
              <h2 className="text-3xl md:text-4xl font-bold mb-4">Get Safari Tips & Exclusive Offers</h2>
              <p className="text-xl mb-8 max-w-2xl mx-auto">
                Subscribe to our newsletter for the latest safari advice, wildlife updates, and special travel deals.
              </p>
