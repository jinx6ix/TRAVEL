...
export default function LandcruiserPage() {
  // Type the featureTextMap with FeatureKey as the key type
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            >
              <img
                src={landcruiserSpecs.image || "/placeholder.svg"}
                alt={landcruiserSpecs.name}
            ...
            >
              ...
              <div className="flex gap-4">
                <Button size="lg" className="flex-1 bg-orange-600 hover:bg-orange-700" asChild>
                  <Link href={`/contact?vehicle=${landcruiserSpecs.name}`}>Book Now</Link>
                </Button>
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          >
            ...
            <p className="text-xl mb-8 max-w-2xl mx-auto">
              Experience the ultimate safari adventure with our reliable Toyota Landcruiser
            </p>
            <div className="flex flex-col md:flex-row gap-4 justify-center">
              <Button size="lg" variant="secondary" asChild>
                <Link href={`/contact?vehicle=${landcruiserSpecs.name}`}>
