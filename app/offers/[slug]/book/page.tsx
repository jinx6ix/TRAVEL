...
export default function BookingPage() {
  ...
  const calculateTotal = () => {
    let total = offer.price * formData.adults + offer.price * 0.7 * formData.children
  ...
  const handleSubmit = async () => {
    ...
    const bookingMessage = `🦁 SPECIAL OFFER BOOKING REQUEST 🦁

📋 OFFER DETAILS:
• Tour: ${offer.title}
• Special Offer: ${offer.offer}
• Destination: ${offer.destination}
• Duration: ${offer.duration}
• Travel Date: ${formData.travelDate}
• Original Price: $${offer.originalPrice}
• Discounted Price: $${offer.price}
• Total Savings: $${offer.originalPrice - offer.price}
...
Please confirm availability and send detailed booking confirmation. Thank you!`
    ...
    // Send email
    const emailSubject = `🦁 Special Offer Booking Request - ${offer.title}`
    ...
    router.push(`/offers/${offer.slug}/book/confirmation`)
  }
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="container mx-auto px-4 py-8">
        {/* Header */}
        <div className="mb-8">
          <Button variant="ghost" onClick={() => router.push(`/offers/${offer.slug}`)} className="mb-4">
          ...
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-bold mb-2">Book Your Special Offer</h1>
              <p className="text-gray-600">Complete your booking for {offer.title}</p>
            </div>
                    ...
                    <div>
                      ...
                      <div className="space-y-4">
                        <div className="flex justify-between items-center">
                          <span>Special Offer Price ({formData.adults} adults)</span>
                          <span>${offer.price * formData.adults}</span>
                        </div>
                        {formData.children > 0 && (
                          <div className="flex justify-between items-center">
                            <span>Children ({formData.children} × 70%)</span>
                            <span>${Math.round(offer.price * 0.7 * formData.children)}</span>
                          </div>
                        )}
                ...
                <CardContent>
                  <div className="space-y-4">
                    ...
                    <div className="bg-orange-50 p-3 rounded-lg">
                      <p className="text-sm font-medium text-orange-700">{offer.offer}</p>
