...
export default function ContactPage() {
  ...
  const generateStructuredData = () => {
    return {
      ...
      "description": "East Africa safari specialist offering wildlife tours, gorilla trekking, and cultural experiences in Kenya, Tanzania, and Rwanda",
            ...
            {[
              {
                ...
                answer:
                  "Our safari packages include accommodation, meals, park fees, professional guide services, and transportation. International flights, visas, and travel insurance are not included.",
              },
              {
                question: "What should I pack for an East African safari?",
                answer:
                  "We recommend light, neutral-colored clothing, comfortable walking shoes, sun protection, binoculars, and camera equipment. We provide a detailed packing list upon booking.",
              },
              {
                question: "Is it safe to travel on safari in East Africa?",
                answer:
                  "Yes, our safaris are designed with safety as the top priority. We use experienced guides, well-maintained vehicles, and follow all recommended safety protocols for wildlife viewing.",
              },
              {
                question: "Can you customize safari tours for special interests?",
                answer:
                  "Absolutely! We specialize in custom safaris for photography, birdwatching, honeymoons, family trips, and special occasions. Contact us to create your ideal itinerary.",
              },
              {
                question: "What is the best time for wildlife viewing in East Africa?",
                answer:
                  "The Great Migration in Serengeti/Masai Mara is best from July-October. Dry seasons (Jan-Feb and Jun-Oct) generally offer the best wildlife viewing conditions.",
              },
              {
                question: "Do you offer gorilla trekking permits?",
                answer:
                  "Yes, we can secure gorilla trekking permits for Rwanda and Uganda. These must be booked well in advance due to limited availability.",
              },
            ].map((faq, index) => (
