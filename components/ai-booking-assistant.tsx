  ...
  const getAIResponse = useCallback(
    (userInput: string): { text: string; tours?: Tour[]; showBookingForm?: boolean } => {
      ...
      if (input.includes("hello") || input.includes("hi") || input.includes("hey")) {
        return {
          text: "Hello! Welcome to Safari Adventures! I'm here to help you find the perfect East African safari experience. What type of adventure are you looking for today?",
